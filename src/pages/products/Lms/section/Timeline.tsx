    ...
    <section ref={containerRef} className="relative w-full bg-[#0a0a0a] py-20 lg:py-40 px-6 overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="flex justify-center mb-20 lg:mb-40 relative z-30">
          <div className="w-16 h-16 lg:w-20 lg:h-20 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-white shadow-[0_0_40px_rgba(0,0,0,0.5)]">
            <Atom className="w-8 h-8 lg:w-10 lg:h-10 animate-[spin_15s_linear_infinite] text-zinc-200" />
          </div>
        </div>
