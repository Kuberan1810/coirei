        ...
        {features.map((item, index) => (
          <div
            ...
            className={`
              ...
              bg-linear-to-b from-[#0b1220] to-[#05080f]
          ...
          >
            {/* Decorative Glow */}
            <div className="absolute inset-0 rounded-2xl bg-linear-to-tr from-indigo-500/10 via-transparent to-purple-500/10 pointer-events-none" />
            {item.position == "top" ? <img src={item.source} alt="component1" className='mb-12.5' /> : ""}
