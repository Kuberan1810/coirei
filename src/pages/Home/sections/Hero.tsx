        ...
        <section className="mt-32 sm:mt-36 lg:mt-40 mb-10 md:mb-20 ">
            ...
            <div className="px-6 sm:px-10 md:px-15">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                    ...
                    {/* LEFT CONTENT */}
                    <div  className="w-full xl:max-w-xl sm:text-start text-center sa-fade-up">
                        ...
                        <div className="flex justify-center sm:justify-start gap-4">
                            <button className="text-[#252525] py-2.5 px-4 bg-[#FAF9F6] rounded font-semibold hover:bg-[#1E1E1E] hover:text-white transition-all duration-500">
                                Request Early Access
                            </button>

                            <button className="text-white py-2.5 px-4 bg-[#292929] rounded font-semibold hover:bg-white hover:text-[#292929] transition-all duration-500">
                    ...
                    <div data-ns-animate
                        ...
                        <div className="relative z-1 h-full flex items-end justify-center px-6 pt-6">
                            <div className="max-w-2xl w-full sa-scale">
                                <CollaborateFeature />
                            </div>
                        </div>
                    </div>
