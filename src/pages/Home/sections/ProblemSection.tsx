        ...
        <section className="px-6 sm:px-10 md:px-15 py-16 md:py-20">
            <div>
                ...
                <div className="flex flex-col justify-center items-center mb-14 md:mb-22 text-center">
                    <p data-ns-animate data-offset="40" className="backdrop-blur-md border border-white/20 rounded-xl py-2 px-4 max-w-fit text-sm sm:text-base text-[#959493] mb-5">
                        Why Orca AI Exist?
                    </p>

                    <h2 data-ns-animate data-offset="120" data-duration="1.2" className="leading-tight text-[#E3E3E0] text-[28px] sm:text-[36px] md:text-[48px] lg:text-[60px] max-w-5xl">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        <ul className="list-disc pl-5 sm:pl-6">
                            ...
                            <li data-ns-animate data-delay="0.15" className="text-[#B5B4B2] text-[18px] sm:text-[20px] md:text-[24px] mb-2">
                                Context gets lost between commits and discussions
                            </li>
                            <li data-ns-animate data-delay="0.3" className="text-[#B5B4B2] text-[18px] sm:text-[20px] md:text-[24px] mb-2">
                                Collaboration creates noise instead of momentum
                            </li>
                            <li data-ns-animate data-delay="0.45" className="text-[#B5B4B2] text-[18px] sm:text-[20px] md:text-[24px] mb-6">
                                Documentation is written after the fact, if at all
                            </li>
                        </ul>

                        <div data-ns-animate data-delay="0.6" data-offset="40" className="inline-flex items-center rounded-md bg-[#2b2b2b] px-3 py-1 text-sm sm:text-[16px] text-gray-300">
                            The Result is
                    ...
                    {/* RIGHT IMAGE */}
                    <div data-ns-animate data-direction="right" data-offset="140" data-duration="1.1" className="w-full lg:w-[570px] h-auto">
