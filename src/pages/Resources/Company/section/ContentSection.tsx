    ...
    return (
        <section className="mt-30 mx-15">
            <div className="w-[100%] flex flex-col justify-center items-center mb-38">
                ...
                <div className="">
                    <div >
                        <p className="text-white/80 text-lg">Coirei began with the vision of re-imagining one of the fundamental
                            devtools – the terminal – to make it more usable and powerful for
                            all developers.</p>

                        <p className="text-white/80 text-lg">  Our mission: to empower developers to ship better software
                        ...
                        <p className="text-white/80 text-lg"> We believe that soon developers will be “tech leads” for
                        ...
                        <p className="text-white/80 text-lg">  In this future, AI doesn’t replace developers, it gives them
                            superpowers. It works alongside them, and together human + AI ship
                            better software together.
                        </p>
                        <p className="text-white/80 text-lg">If you’re excited about building this future, come join us</p>
                    </div>
                </div>
            </div>
