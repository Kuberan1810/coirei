    ...
    return (
        <section className="mx-6 sm:mx-10 md:mx-15 py-16 sm:py-20">
            <div className="flex flex-col gap-10 sm:gap-15">
                ...
                {/* HEADING */}
                <div>
                    <h2 data-ns-animate data-offset="90" data-duration="1.2" data-direction="up" className="text-[32px] sm:text-[40px] md:text-[48px] lg:text-6xl text-white max-w-4xl leading-tight">
                        <span data-ns-animate data-delay="0.15" data-offset="60" data-direction="up" className="text-[#FF8800]">Private and Secure</span>
                        <br />
