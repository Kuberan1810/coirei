        ...
        <section className="mx-6 sm:mx-10 md:mx-15 py-16 sm:py-20">
            <div>
                ...
                <div className="flex flex-col md:flex-row gap-8 md:gap-10 items-start md:items-end">
                    ...
                    {/* IMAGE */}
                    <div data-ns-animate data-delay="0.15" data-offset="80" data-direction="up" className="w-full md:w-auto ">
                        <img src={Ceo} alt="CEO" className="md:w-40 xl:w-full max-w-sm rounded-xl" />
                    </div>

                    {/* QUOTE */}
                    <div>
                        <p data-ns-animate data-delay="0.3" data-offset="60" data-direction="up" className="text-[20px] sm:text-[24px] md:text-[28px] lg:text-[36px] font-normal text-[#E3E3E0] max-w-264 leading-tight sm:leading-snug">
                            “The future isn’t about better AI suggestions.
                        </p>
                        <p data-ns-animate data-delay="0.45" data-offset="60" data-direction="up" className="text-[20px] sm:text-[24px] md:text-[28px] lg:text-[36px] font-normal text-[#E3E3E0] max-w-264 leading-tight sm:leading-snug">
